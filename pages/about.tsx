  ...
  return (
    <Container>
      ...
      <AboutText size={16} lineHeight={24} weight={400} color={"black"}>
        ...
        streetwear, sportswear, casual, vintage sportswear, vintage sportswear,
        vintage casual, new vintage, new wave. Каждый пользователь нашего
        сервиса может выступать в роли продавца или покупателя.
      </AboutText>
      <AboutText size={16} lineHeight={24} weight={400} color={"black"}>
        ...
        интересных, брендовых вещей по адекватной цене, в которой можно пойти на
